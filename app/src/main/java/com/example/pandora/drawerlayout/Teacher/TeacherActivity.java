...
public class TeacherActivity extends AppCompatActivity {
    ...
    private void profileFragment(){
        ...
        fragmentTransaction.add(R.id.teacherFragment, teacherProfileFragment, "teacherProfile");
        fragmentTransaction.commit();
    }

    private void teachClassFragment(){
        FragmentManager fragmentManager = getFragmentManager();
        FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();

        TeacherClass teacherClass = new TeacherClass();

        fragmentTransaction.add(R.id.teacherFragment, teacherClass, "todayClass");
        fragmentTransaction.commit();
    }

    private void teacherTimeTable(){
        FragmentManager fragmentManager = getFragmentManager();
        FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
